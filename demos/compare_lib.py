...
def get_parser():
    ...
    parser.add_argument("--dir", type=str, default="./lib_tests/sps_home-aa77c3_pyfsps-42635d_pyfslib-aa77c3",
                        help="Output directory for test results")
    parser.add_argument("--kind", type=str, default="constneb", choices=["const", "constneb", "tau1"],
                        help="Kind of SFH to plot spectrum of.")
    parser.add_argument("--filters", type=str, nargs=2, default=["bessell_B", "bessell_V"],
...
if __name__ == "__main__":
    ...
    tags = [os.path.basename(t).replace("color_evol_", "").replace(".csv", "") for t in tbls]
    ...
    for tag in tags:
        ...
        try:
            ...
            ax.plot(table["log_age"], table[f1] - table[f2], f"-{marker}", color=color, mec=color, alpha=0.5, label=f"{tag}, [a/Fe]=0.0")
